...
<p align="center">
  <img
    src="assets/demo.png"
    width="420"
    alt="Complete portrait game screen showing the visual style across character art, environment, gameplay tiles, and UI."
  >
</p>

<p align="center">
  <img
    src="assets/all-items.png"
    width="47%"
    alt="Item collection demonstrating consistent shapes, outlines, colors, and rendering rules."
  >
  &nbsp;
  <img
    src="assets/native-sheet.png"
    width="47%"
    alt="Native-size validation sheet showing game assets at their intended display sizes."
  >
</p>

<p align="center">
  <sub>
    Complete game screen · Item family · Native-size readability test
  </sub>
</p>
